...
class BoundingBoxConstantVelocity(MotionModel):
    ...
    @staticmethod
    def create_initial_state(measurement: jnp.ndarray, 
                           initial_velocity: jnp.ndarray = None) -> jnp.ndarray:
        """
    ...
    @staticmethod
    def create_initial_covariance(position_std: float = 10.0,
                                size_std: float = 5.0,
                                velocity_std: float = 1.0) -> jnp.ndarray:
        """
